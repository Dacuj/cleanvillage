...
const TWEAKS_STYLE = `
  ...
  .twk-x{appearance:none;border:0;background:transparent;color:rgba(41,38,27,.55);
    width:22px;height:22px;border-radius:6px;cursor:pointer;font-size:13px;line-height:1;display:grid;place-items:center}
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          background: open ? 'var(--color-teal-500)' : 'rgba(250,249,247,0.92)',
          color: open ? '#fff' : '#29261b',
